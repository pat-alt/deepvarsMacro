...
```{r, eval=TRUE, fig.cap="Train sample RMSE for Deep VAR for different variables."}
knitr::include_graphics("www/grid_rmse_train.png")
```

```{r, eval=TRUE, fig.cap="Test sample RMSE for Deep VAR for different variables."}
