...
ggsave("../www/rolling_window_recursive_cum_loss.png")
```
...
```{r cum-rolling-full, eval=TRUE, fig.cap="Comparison of cumulative rolling-window forecasting error over the entire sample period for Deep VAR and benchmarks."}
