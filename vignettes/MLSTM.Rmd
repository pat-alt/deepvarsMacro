...
mlstm_model <- mlstm(mlstm_data, n_units = 150) # prepare model
mlstm_model <- fit(mlstm_model, verbose=0, epochs=200) # fit model
```
...
tab_rmse <- dcast(tab_rmse, variable ~ model, value.var = "rmse")
knitr::kable(
  tab_rmse, 
