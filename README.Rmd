...
- **Abstract**
- Polish **literature review**; turn into more of an introduction + lit review
- Section on **Data** (Ignacio)
- Section on **Methodology** (Pat)
- Section on **Empirical Findings** (everyone, Marc to start)
    - Use package for model comparison: VAR, MLSTM (preferred VAR-type), MLSTM (timestamps for lags)
...
- Section on **Caveats, Interpretability and Extensions** (links to NAVAR and Verstyuk)
...
> Then to see how everything works simply look at the vignette about deep vars:
