...
column_numbers: 3
primary_colour: "#00477a"
secondary_colour: "#0697fd"
accent_colour: "#a909e3"
logoright_name: https&#58;//raw.githubusercontent.com/pat-alt/deepvars/master/www/qr-code.png
...
knitr::kable(
  tab_rmse, 
  col.names = c("Variable", "DVAR", "VAR", "Ratio (DVAR / VAR)"),
  digits = 5,
  caption = 'Test root mean squared error (RMSE) for the two models across variables.'
) 
```
...
2. **Structural Identification**: @verstyuk2020modeling works with a Cholesky decomposition of the residual covariance matrix in the same way as for conventional VAR.
3. **IRFs, variance decomposition, ...**: Existing approaches solve (some of) this through simulation [@verstyuk2020modeling]. 

## Applications

We believe there are useful applications for Deep VAR.
